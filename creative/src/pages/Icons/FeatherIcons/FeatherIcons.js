                        ...
                        <Col xs={12}>
                            <Card >
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;i data-featherIcon icon="**"/&gt;</code> class.</p>
                                </CardHeader>
                        ...
                        <Col xs={12} >
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;i data-feather="activity" class="icon=**"/&gt;</code> class.Available sizes <code>xs, sm,md,lg,xl,xxl</code></p>
                                </CardHeader>
                                <CardBody className="pt-0">
                                    <Row className="icon-demo-content">
                        ...
                        <Col xs={12}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;i data-feather="activity" class="icon-dual-**" /&gt;</code>.</p>
                                </CardHeader>
                                <CardBody className="pt-0">
