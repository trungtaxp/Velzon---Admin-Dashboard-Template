                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StepLineChart dataColors='["--vz-primary", "--vz-gray-300", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <BarLabelChart dataColors='["--vz-primary", "--vz-info", "--vz-success", "--vz-gray-300"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StackedHorizontalBarChart dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <PieChart dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <FunnelChart dataColors='["--vz-primary", "--vz-secondary", "--vz-info", "--vz-success", "--vz-wrning"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
