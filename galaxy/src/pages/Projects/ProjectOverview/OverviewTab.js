                    ...
                    <Card>
                        <CardBody>
                            ...
                            <div className="d-flex flex-wrap gap-2 fs-16">
                                <div className="badge fw-medium badge-soft-primary">UI/UX</div>
                                <div className="badge fw-medium badge-soft-primary">Figma</div>
                                <div className="badge fw-medium badge-soft-primary">HTML</div>
                                <div className="badge fw-medium badge-soft-primary">CSS</div>
                                <div className="badge fw-medium badge-soft-primary">Javascript</div>
                                <div className="badge fw-medium badge-soft-primary">C#</div>
                                <div className="badge fw-medium badge-soft-primary">Nodejs</div>
                            </div>
                        </CardBody>
